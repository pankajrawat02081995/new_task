...
struct UserBasicDetails: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case jwt_token, first_name, last_name, email, phone, user_type, apple_token, google_token, occupation, company, signature, username, profile_picture,is_subscription,trial_ended,safety_card,trade_licence,id
