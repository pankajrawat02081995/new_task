...
class EditProfileViewModel:NSObject{
    func updateProfile(firstName:String, lastName:String, phone: String, occupation: Int ,company: String ,profilePicture:String,abn: String, address: String, completionHandler: @escaping(_ status: Bool, _ editProfile: EditProfileModel?, _ errorMsg: String?) -> Void){
  
    var parameters = [String : Any]()
    
    
        parameters = ["first_name":firstName,"last_name":lastName,"phone":phone,"occupation":occupation,"company":company, "profile_picture":profilePicture, "ABN": abn, "address": address]
