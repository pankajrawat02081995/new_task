...
struct PurchaseListModel : Codable {
    let status : String?
    let code : Int?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(PurchaseListData.self, forKey: .data)
...
struct PurchaseListData : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        results = try values.decodeIfPresent(PurchaseResults.self, forKey: .results)
    }

}


struct PurchaseResults : Codable {
    let purchase_details : [Purchase_details]?
    ...
    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        purchase_details = try values.decodeIfPresent([Purchase_details].self, forKey: .purchase_details)
    }

}


struct Purchase_details : Codable {
    let id : Int?
    let currency : String?
    let created_date : String?
    let purchase_code : String?
    let amount_of_purchase : Double?
    let owner : PurchaseOwner?
    let client : PurchaseClient?
    let project : PurchaseProject?
    let address : PurchaseAddress?
    ...
    init(from decoder: Decoder) throws {
        ...
        owner = try values.decodeIfPresent(PurchaseOwner.self, forKey: .owner)
        client = try values.decodeIfPresent(PurchaseClient.self, forKey: .client)
        project = try values.decodeIfPresent(PurchaseProject.self, forKey: .project)
        address = try values.decodeIfPresent(PurchaseAddress.self, forKey: .address)
    }

}

struct PurchaseClient : Codable {
    let id : Int?
    let username : String?
    let email : String?
...
struct PurchaseProject : Codable {
    let id : Int?
    let name : String?
    let address : Int?
    let client : Int?
...
struct PurchaseAddress : Codable {
    let id : Int?
    let name : String?
