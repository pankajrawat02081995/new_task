...
class PLFilterVC: UIViewController {
    ...
    @IBAction func btnClearClicked(_ sender: UIButton) {
        ...
        self.dismiss(animated: true) {
            if let del = self.delegate{
                del.PlFilter(startDate: "", endDate: "")
            }
        }
    }
    ...
    @IBAction func btnSubmitClicked(_ sender: UIButton) {
        self.dismiss(animated: true) {
            if let del = self.delegate{
                del.PlFilter(startDate: self.startDate , endDate: self.endDate)
            }
        }
    ...
    @IBAction func lblEndDateClicked(_ sender: UIButton) {
