...
class AddProjectVC: UIViewController {
    ...
    @IBOutlet weak var txtJobNumber: UITextField!
...
extension AddProjectVC: CLLocationManagerDelegate {
    
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        guard let currentLocation = locations.last else { return }
        
        // Stop updating the location once you have obtained the current location
        manager.stopUpdatingLocation()
        
        // Use geocoding to get the address from the current location
        getAddressFromLocation(location: currentLocation.coordinate)
    }
